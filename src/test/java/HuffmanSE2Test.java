 ...
 * Description : This program tests the program that compresses a file using Huffman encoding.
 * Author      : Jun Kim
 * Date        : 03/08/2024
 * Course      : CS375
...
public class HuffmanSE2Test {
    ...
    public void testEmptyFile() throws IOException {
        ...
        if (new File(uncompPath).length() > 0) {
            ...
            System.err.println("The uncompressed file is empty. Skipping the compression test.");
            assertTrue(true);
        }
    ...
    public void testMissingUncompressedFile() {
        ...
        try {
            ...
            fail("Expected RuntimeException for missing uncompressed file, but no exception was thrown.");
        } catch (NullPointerException e) {
            // If a NullPointerException is thrown, the test is successful
            assertTrue("Expected NullPointerException for missing uncompressed file", true);
        }
        System.err.println("Test passed.\n");
    }
    ...
    public void testContainMany() {
        ...
        String testContent = "Lorem ipsum dolor sit amet, 123 consectetur adipiscing elit. "
    ...
    public void testWrongNumberOfArguments() throws IOException {
        ...
        try {
            ...
            // Verify that output contains information about the wrong number of arguments
            if (output.contains(
    ...
    public void testReallyLong() {
        ...
        // Create a test file with various characters, numbers, and other stuff
        String testContent = "BleeBlahBloowaitwhatisthisBleeBlahBloowaitwhatisthisBleeBlahBloowaitwhatisthisBleeBlahBloowaitwhatisthisBleeBlahBloowaitwhatisthis"
                +
    ...
    public void onlyLowerCase() {
        ...
        // Create a test file with various characters, numbers, and other stuff
        String testContent = "loremipsumdolorsitametconsecteturadipiscingelitseddoeiusmodtemporincididuntulaboreetdoloremagnaaliqua";
    ...
    public void testLog() {
        ...
        // Create a test file with various characters, numbers, and other stuff
        String testContent = "bleeblahblueblahwhatisthisbleeblahblooblahbluebleeblee";
